package com.zenz.neopay.api.route.invoice;

import com.zenz.neopay.api.route.invoice.request.CreateInvoiceRequest;
import com.zenz.neopay.api.route.invoice.response.InvoiceResponse;
import com.zenz.neopay.entity.Invoice;
import com.zenz.neopay.entity.User;
import com.zenz.neopay.service.InvoiceService;
...
@RestController
@RequestMapping("/merchants/{merchantId}/invoices/")
